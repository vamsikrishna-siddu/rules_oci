...
def rules_oci_dependencies():
    ...
    http_archive(
    	...
    	strip_prefix = "bazel-lib-f7b2db272345a7252ca8ac41bc6a1897c79bda76",
    	url = "https://github.com/vamsikrishna-siddu/bazel-lib/archive/f7b2db272345a7252ca8ac41bc6a1897c79bda76.tar.gz",
    )
